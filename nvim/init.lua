...
require("packer").startup(function(use)
  ...
  use("kvrohit/substrata.nvim") -- Substrata colorscheme
  use("kvrohit/rasmus.nvim") -- Rasmus colorscheme
  use("/Users/rohit/play/neovim/mellow.nvim")
...
vim.keymap.set("n", "<leader>w", require("telescope.builtin").grep_string, { desc = "Search current word" })
vim.keymap.set("n", "<leader>/", require("telescope.builtin").live_grep, { desc = "Global search" })
...
vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Set all diagnostics to quickfix list" })
